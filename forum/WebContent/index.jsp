...
function CheckForm(){
	if(document.form_index.loginEmail.value == ""){
		alert("邮箱不能为空");
		document.form_index.loginEmail.focus();
    ...
    <form id="form_index" name="form_index" method="post">
      <table width="327" border="0" class="table_logo">
        <tr>
          ...
          <td width="142" height="34" align="right" valign="middle">账号：</td>
          <td width="218">
            <input type="text" name="loginEmail" id="loginEmail" height="25px"/>
          </td>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="loginPassword" id="loginPassword" height="25px"/>
            <input type="button" name="login" id="login" value="登录" style="height:25px" onclick="CheckForm()"/>
          </td>
          <td align="left"><a href="register.jsp"><%=session.getAttribute("email") %>注册</a></td>
        </tr>
      </table>
      </form>
      <%}else{ %>
