...
function SubmitForm(){	
	document.form_info.action = "<%=request.getContextPath()%>/toIndex.do?value=1";
      ...
      <div class="div_sub_title">
        <table width="100%">
          <tr>
            ...
            <td colspan="3" align="right"><a href="<%=request.getContextPath() %>/toModifyPwd.do"><b>修改密码</b></a></td>
          </tr>
        </table>
      </div>
