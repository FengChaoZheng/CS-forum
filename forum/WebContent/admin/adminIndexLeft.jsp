...
<table width="101%">
  <tr>
    <td><div> <a href="menu1.html" class="menuLink">用户管理</a>
      <ul class="menu" id="menu1">
        <li><a href="" target="mainFrame">查看用户</a></li>
  ...
  <tr>
    <td><div> <a href="menu3.html" class="menuLink">事务管理</a>
      <ul class="menu" id="menu3">
        <li><a href="" target="mainFrame">发布公告</a></li>
        <li><a href="" target="mainFrame">删除公告</a></li>
